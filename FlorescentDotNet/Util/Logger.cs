...
public class Logger
{
    ...
    {
        string timestamp =
            String.Format("[{0}:{1}:{2}]", DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Millisecond);
    ...
    public static void WriteLogCacheToFile()
    {
        string fileName = String.Format("{0}{1}{2} {3}{4}{5}.txt", DateTime.Now.Year, DateTime.Now.Month,
            DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Millisecond);
